        ...
        <form method="POST" action="{{ route('subduas.store') }}"> {{--  //! Clase  31 tenia action en lugar de method --}}
            ...
            <div class="form_row">
                ...
                <div class="form_row">
                    ...
                    <input class="form-control" maxlength="60" type="text" name="nomsubdua"
                        value="{{ old('nomsubdua') }}" requiered>
                </div> <br>
                <div class="form_row">
                    <label>Dom SubDua</label>
                    <input class="form-control" maxlength="40" type="text" name="sububicaion"
                ...
                <div class="form_row">
                    <label>Zona</label>
                    <input class="form-control" maxlength="04" type="text" name="zona" value="{{ old('zona') }}"
                        requiered>
                    <br>
                </div> <br>
                <div class="form_row">
                    <label>subeexp</label>
                    <input class="form-control" maxlength="08" type="text" name="subeexp" value="{{ old('subeexp') }}"
                        requiered>
                    <br>
                </div> <br>
                <div class="form_row">
                ...
                <div class="form_row">
                    <label>Giro</label>
                    <input class="form-control" maxlength="40" type="text" name="subdesgiro"
                ...
                <div class="form_row">
                    ...
                    <input class="form-control" maxlength="20" type="text" name="subrfc" value="{{ old('subrfc') }}"
                        requiered>
                    <br>
                </div> <br>
                <br>
                <div class="form_row">
                    ...
                    <input class="form-control" maxlength="40" type="text" name="propnom" value="{{ old('propnom') }}"
                        requiered>
                    <br>
                </div> <br>
                <div class="form_row">
                    <label>Dom. Propietario</label>
                    <input class="form-control" maxlength="40" type="text" name="propdir" value="{{ old('propdir') }}"
                        requiered>
                    <br>
                </div> <br>
                <div class="form_row">
                    <label>Tel. Propietario</label>
                    <input class="form-control" maxlength="20" type="text" name="proptel" value="{{ old('proptel') }}"
                        requiered>
                    <br>
                </div> <br>
