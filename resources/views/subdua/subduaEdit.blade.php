    ...
    <form method="POST" action="{{ route('subduas.update', ['subdua' => $items->subdua]) }}"> {{--  //! Clase  31 tenia action en lugar de method --}}
        ...
        <div class="form_row">
            ...
            <div class="form_row">
                ...
                <input class="form-control" maxlength="60" type="text" name="nomsubdua" value={{ $items->nomsubdua }}
                    requiered>
            </div> <br>
            <div class="form_row">
                <label>Dom SubDua</label>
                <input class="form-control" maxlength="40" type="text" name="sububicacion" value={{ $items->sububicaion }}
                    requiered>
                <br>
            </div> <br>
            <div class="form_row">
            ...
            <div class="form_row">
                <label>Zona</label>
                <input class="form-control" maxlength="04" type="text" name="zona" value={{ $items->zona }}
                    requiered>
                <br>
            </div> <br>
            <div class="form_row">
                <label>subeexp</label>
                <input class="form-control" maxlength="08" type="text" name="subeexp" value={{ $items->subeexp }}
                    requiered>
                <br>
            </div> <br>
            <div class="form_row">
                <label>Tel. Subdua</label>
                <input class="form-control" maxlength="20" type="text" name="subtelefono"
                    value={{ $items->subtelefono }} requiered>
                <br>
            </div> <br>
            <div class="form_row">
                <label>Giro</label>
                <input class="form-control" maxlength="40" type="text" name="subdesgiro" value={{ $items->subdesgiro }}
                    requiered>
                <br>
            </div> <br>
            <div class="form_row">
                <label>Uso de Suelo</label>
                <input class="form-control" maxlength="40" type="text" name="subusossuelo"
                    value={{ $items->subusossuelo }} requiered>
                <br>
            </div> <br>
            <div class="form_row">
                <label>RFC SubDua</label>
                <input class="form-control" maxlength="20" type="text" name="subrfc" value={{ $items->subrfc }}
                    requiered>
                <br>
            </div> <br>
            <br>
            <div class="form_row">
                ...
                <input class="form-control" maxlength="40" type="text" name="propnom" value={{ $items->propnom }}
                    requiered>
                <br>
            </div> <br>
            <div class="form_row">
                <label>Dom. Propietario</label>
                <input class="form-control" maxlength="40" type="text" name="propdir" value={{ $items->propdir }}
                    requiered>
                <br>
            </div> <br>
            <div class="form_row">
                <label>Tel. Propietario</label>
                <input class="form-control" maxlength="20" type="text" name="proptel" value={{ $items->proptel }}
                    requiered>
                <br>
            </div> <br>
            ...
            <form action="/action_page.php">
                ...
                <input type="text" maxlength="08"id="fbajax" name="fbajax" placeholder="AAAAMMDD" pattern="[0-9]{8}"
                    value={{ $items->fbajax }}><br><br>
