...
@section('content')
    {{-- //! Clase 31 --}}
    <h1>Muestra Anuncio</h1>


    <h1>Dua {{ $ditems->dua }}</h1>
    <h1>Dom. Dua {{ $ditems->nomdua }}</h1>
    <h2>Sub Dua {{ $sitems->subdua }}</h2>
    <h2>Dom. SubDua {{ $sitems->sububicaion }}</h2>
    ...
    <div class="form_row">
        ...
        {{-- //! Clase  40 old --}}
        <label>dua</label>
        <input class="form-control" maxlength="60" type="text" name="dua" readonly value={{ old('dua') ?? $items->dua }}
            requiered>
    ...
    <div class="form_row">
        ...
        <input type="text" maxlength="08"id="fperm" name="fperm" placeholder="AAAAMMDD" pattern="[0-9]{8}" readonly
    ...
    <div class="form_row">
        ...
        <input type="text" maxlength="08"id="fbajax" name="fbajax" placeholder="AAAAMMDD" pattern="[0-9]{8}"
            readonly value={{ old('fbajax') ?? $items->fbajax }}>
        <br><br>

        <label for="fnotifica">Fecha Notifica:</label><br><br>
        <input type="text" maxlength="08"id="fnotifica" name="fnotifica" placeholder="AAAAMMDD" pattern="[0-9]{8}"
            readonly value={{ old('fnotifica') ?? $items->fnotifica }}>
        <br><br>


        <label for="freq">Fecha Requerimiento:</label><br><br>
        <input type="text" maxlength="08"id="freq" name="freq" placeholder="AAAAMMDD" pattern="[0-9]{8}"
            readonly value={{ old('freq') ?? $items->freq }}>
        <br><br>
        ...
        <input type="text" maxlength="08"id="fembargo" name="fembargo" placeholder="AAAAMMDD" pattern="[0-9]{8}"
            readonly value={{ old('fembargo') ?? $items->fembargo }}>
        <br><br>
        ...
        <div class="form_row">
        <td> <a href="{{ route('anuncios.lanuncios', ['subdua' => str_pad($sitems->subdua, 6, '0', STR_PAD_LEFT)]) }}" class="btn btn-link">Lista Anuncios </td>
        </div> <br>
